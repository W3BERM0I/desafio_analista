<template>
    <div class="button" :class="{ 'button--disabled': disabled }" role="button">
        <div
        ...
        <div class="button__content">
            ...
            >
                Escolha sua <strong>foto</strong>
            </h3>
...
const boldTitle = arrayTitle.slice(-1).join('foto');
...
.button {
    ...
    box-shadow: 0 0 20px var(--neutro-claro);
